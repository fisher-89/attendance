...
class Sign extends Model
{
     ...
     *
     */
    public static function staff_arrived()
    {
     ...
     * 当月早上迟到
     */
    public static function staff_morning_arrived($staff_sn)
    {
     ...
     * 当月下午迟到
     */
    public static function staff_after_arrived($staff_sn)
    {
     ...
     * return $result
     */
    public static function user_attendance_data()
    {
        $result   = [];
