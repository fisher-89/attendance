...
class AttendanceController extends Controller
{
    ...
    public function getAttendanceSheet()
    {
        if (app('CurrentUser')->isShopManager()) {
            ...
            return $this->attendanceRepos->getAttendanceDataByShop($shopSn);
        }
    }
    ...
    public function getrecordlist(Request $request)
    {
        ...
        if (empty($staff_info['message'][0]['shop_sn'])) {
            return 'error';
        }
